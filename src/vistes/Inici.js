...
`
  return (
    ...
    <div style={{ textAlign: 'left' }}>
      ...
      <p>11. Separar la lógica del componente de la funcionalidad especifica. Ejemplo componente btn de MUI que recibe un OnClick y la persona se encarga de darle un uso especifico.</p>
